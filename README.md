...
![alt text](https://github.com/kimbring2/OpenAI_Requests-For-Research-2_Slitherin/blob/master/image/under-construction-3-561190.png | width=100) The phenomenon that one agent collides with the wall continuously when both agents are present
