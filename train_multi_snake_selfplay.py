    ...
    with tf.Session() as sess:
        ...
        for i in range(num_episodes):
            ...
            while j < max_epLength: #If the agent takes longer than 200 moves to reach either of the blocks, end the trial.
                ...
                #print("s_agent2[:,:,0]: " + str(s_agent2[:,:,0]))
                #print("d_agent1: " + str(d_agent1))

                total_steps += 1
                if d_agent1 == False:
                    #print("s_agent1[:,:,0]: " + str(s_agent1[:,:,0]))
                    #print("rAll_agent2: " + str(rAll_agent2))
                    #print("d_agent2: " + str(d_agent2))
                    #print("s_agent1[:,:,0]: " + str(s_agent1[:,:,0]))
                    #print("s1_agent1[:,:,0]: " + str(s1_agent1[:,:,0]))
                    #print("a_agent1: " + str(a_agent1))
                    #print("")
                    episodeBuffer[0].add(np.reshape(np.array([s_agent1,a_agent1,r_agent1,s1_agent1,d_agent1]),[1,5]))
                if d_agent2 == False:
                    #print("s_agent2[:,:,0]: " + str(s_agent2[:,:,0]))
                    #print("s1_agent2[:,:,0]: " + str(s1_agent2[:,:,0]))
            ...
            #for data in episodeBuffer[win_index].buffer:
