...
class MultiSnake(gym.Env):
    ...
    def step(self, actions):
        ...
        #print("obs_array.shape: " + str(obs_array.shape))
        #print("obs_array: " + str(obs_array))
        #print("self.killed: " + str(self.killed))
        #print("obs_array[0][:,:,0]: ")
        #print(obs_array[0][:,:,0])
        #print("obs_array[1][:,:,0]: ")
        #print(obs_array[1][:,:,0])
        ...
        #print("np.hstack(new_obs[0]): ")
        #print(str(np.hstack(new_obs[0])))

        #print("np.hstack(new_obs[1]): ")
        #print(str(np.hstack(new_obs[1])))
        #print("")
