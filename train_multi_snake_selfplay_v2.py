...
saving_path = "./dqn_single" # The path to save our model to.
loding_path = "./dqn_multi"
...
def main(config):
    ...
    with tf.Session() as sess:
        ...
        if load_model == True:
            ...
            ckpt = tf.train.get_checkpoint_state(loding_path)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--endE", default=0.1, type=float, help='Final chance of random action')
